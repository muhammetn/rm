...
class LoginView: UIView {
    ...
    let checkImg: UIImageView = {
        let img = UIImageView()
        img.translatesAutoresizingMaskIntoConstraints = false
        img.image = UIImage(named: "State=Passive")
        img.contentMode = .scaleAspectFit
        return img
    }()
    
    let usageDescLb: UILabel = {
        let lb = UILabel()
        lb.translatesAutoresizingMaskIntoConstraints = false
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            stackView.leadingAnchor.constraint(greaterThanOrEqualTo: cardView.leadingAnchor, constant: 16),
            stackView.trailingAnchor.constraint(lessThanOrEqualTo: cardView.trailingAnchor, constant: -16),
            stackView.centerXAnchor.constraint(equalTo: cardView.centerXAnchor),
            stackView.topAnchor.constraint(equalTo: phoneField.bottomAnchor, constant: 16),
